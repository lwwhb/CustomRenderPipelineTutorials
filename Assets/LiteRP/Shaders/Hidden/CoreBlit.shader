Shader "Hidden/LiteRenderPipeline/CoreBlit"
{
    HLSLINCLUDE
        ...
        half4 FragmentLiteRPBlit(Varyings input, SamplerState blitsampler)
        {
    ...
    SubShader
    {
        Tags{ "RenderPipeline" = "LiteRenderPipeline" }
        ...
        Pass
        {
            ...
            {
                return FragmentLiteRPBlit(input, sampler_LinearClamp);
            }
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            {
                return FragmentLiteRPBlit(input, sampler_PointClamp);
            }
            ENDHLSL
        }
    }
