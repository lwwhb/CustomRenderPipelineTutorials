#ifndef LITERP_PARTICLES_UNLIT_FORWARD_PASS_INCLUDED
#define LITERP_PARTICLES_UNLIT_FORWARD_PASS_INCLUDED

#include "ParticlesSurfaceData.hlsl"

void InitializeInputData(VaryingsParticle input, ParticlesSurfaceData surfaceData, out InputData inputData)
{
...
void InitializeSurfaceData(ParticleParams particleParams, out ParticlesSurfaceData surfaceData)
{
    surfaceData = (ParticlesSurfaceData)0;
...
VaryingsParticle ParticlesUnlitPassVertex(AttributesParticle input)
{
...
half4 ParticlesUnlitPassFragment(VaryingsParticle input) : SV_Target
{
    UNITY_SETUP_INSTANCE_ID(input);
    ...
    ParticlesSurfaceData surfaceData;
